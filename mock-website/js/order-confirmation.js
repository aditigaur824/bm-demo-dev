...
var textElement = document.getElementById("order-confirmation");
var orderText = document.createTextNode("Order Id: " + orderId.toString());
textElement.append(orderText);

var botUrl = 'https://rbm-boot-camp-15.wl.r.appspot.com/submitorder?cartId=' + cartId
    + "&orderId=" + orderId; 
const getOrder = async function(url) {
