...
public class DataManagerTest {
    ...
    public void testGetItem() {
        ...
        datastore.put(transaction, testGetItem);
        transaction.commit();

        assertTrue("Getting existing item has failed.", datamanager.getExistingItem(testGetItemConversationId, testGetItemTitle) != null);
    }
    ...
    public void testDeleteItemFromCart() {
        ...
        DatastoreService datastore = DatastoreServiceFactory.getDatastoreService();
        Transaction transaction = datastore.beginTransaction();
        datastore.put(transaction, testDeleteItem);
        transaction.commit();
    ...
    public void testGetCart() {
        ...
        datastore.put(transaction, testGetCartItem1);
        datastore.put(transaction, testGetCartItem2);
        transaction.commit();
